  ...
  const renderItem = (index: number) => {
    ...
    return (
      ...
      >
        ...
        {/* <Prev
          className="absolute left-1 sm:left-5 bottom-[30px] sm:-translate-y-1/2 z-10 text-slate-700"
          btnClassName="w-12 h-12 hover:border-slate-400 dark:hover:border-slate-400"
          svgSize="w-6 h-6"
          onClickPrev={handleClickPrev}
        />
        <Next
          className="absolute right-1 sm:right-5 top-3/4 xs:top-1/2 sm:-translate-y-1/2 z-10 !text-slate-700"
          btnClassName="w-12 h-12 hover:border-slate-400 dark:hover:border-slate-400"
          svgSize="w-6 h-6"
        ...
        <div className="relative min-h-[205px]  container pb-0 pt-14 sm:pt-20 lg:py-44">
          <div
            className={` hidden relative z-[1] w-full max-w-3xl space-y-8 sm:space-y-14 nc-SectionHero2Item__left`}
          >
          ...
          <div className="mt-10 lg:mt-0 lg:absolute right-0 bottom-0 top-0 w-full max-w-2xl xl:max-w-3xl 2xl:max-w-4xl">
            <Image
              fill
              // sizes="(max-width: 768px) 100vw, 50vw"
              className="w-full h-full max-h-[205px] object-cpver object-right-bottom nc-SectionHero2Item__image"
              src={item.image}
              alt={item.heading}
              priority
            />
